...
//         </div>
//         <div>
//           <label htmlFor="cover" className="block text-sm font-medium text-gray-700 mb-1">Sampul
//             (Gambar)</label>
//           <input
//             type="file"
//             id="cover"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500"
            placeholder="Contoh: Publikasi ini membahas Indikator Ekonomi DK Jakarta 2025 secara mendalam."
            rows={4}
          />
        </div>
        <div>
